# Graph Report - cover-letter-writer  (2026-05-21)

## Corpus Check
- 67 files · ~81,880 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 208 nodes · 182 edges · 42 communities detected
...
4. `POST()` - 4 edges
5. `BlogPost()` - 4 edges
6. `textFromFirst()` - 3 edges
7. `linkedInDescriptionText()` - 3 edges
8. `formatLinkedInJobText()` - 3 edges
9. `formatDate()` - 3 edges
10. `getReadingTime()` - 3 edges
...
Cohesion: 0.57
Nodes (5): BlogPost(), formatDate(), generateMetadata(), generateStaticParams(), getReadingTime()

### Community 4 - "Community 4"
Cohesion: 0.52
Nodes (5): cleanJobDescription(), downloadPdf(), Profile(), SavedLetterCard(), SkeletonCard()

### Community 5 - "Community 5"
Cohesion: 0.73
Nodes (5): formatLinkedInJobText(), linkedInDescriptionText(), normalizeSpaces(), POST(), textFromFirst()

### Community 6 - "Community 6"
Cohesion: 0.53
Nodes (4): BlogsPage(), formatDate(), getExcerpt(), getReadingTime()

### Community 7 - "Community 7"
Cohesion: 0.6
Nodes (3): downloadPdf(), Letter(), LetterCard()
...
## Knowledge Gaps
- **Thin community `Community 1`** (17 nodes): `InsightPanel()`, `ResumeAnalysisPage()`, `page.js`, `page.js`, `page.js`, `page.js`, `page.js`, `page.js`, `ResumePreviewPage()`, `api.js`, `authHeaders()`, `fetchJson()`, `ResumeDashboardPage()`, `ResumeTailorPage()`, `TabButton()`, `TemplateSelectionPage()`, `UploadResumePage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 8`** (5 nodes): `PricingCard.jsx`, `page.js`, `PricingCard.jsx`, `PricingPage()`, `PricingCard()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 9`** (4 nodes): `Navbar.js`, `DesktopNavItem()`, `isActivePath()`, `MenuLink()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 10`** (3 nodes): `middleware()`, `middleware.js`, `middleware.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 11`** (3 nodes): `Home()`, `page.js`, `page.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 36`** (3 nodes): `WaveCanvas.jsx`, `WaveCanvas.jsx`, `WaveCanvas()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 37`** (3 nodes): `page.js`, `Dashboard()`, `page.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (3 nodes): `page.js`, `page.js`, `OnboardingPage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 39`** (3 nodes): `page.js`, `page.js`, `page()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 40`** (3 nodes): `page.js`, `page.js`, `PurchasesPage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (3 nodes): `SanitizeCovLetter.js`, `SanitizeCovLetter.js`, `sanitizeCoverLetter()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Navbar()` connect `Community 0` to `Community 8`, `Community 9`?**
